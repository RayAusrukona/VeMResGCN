...
def parse_option():
    ...
    parser.add_argument("--train_data_path", default='data/',  help="Path to train data CSV")  # from this path take dataset  1 - 74
    parser.add_argument("--valid_data_path", default='data/', help="Path to validation data CSV")    # from this path take dataset_valid  75 - 124
    ...
    parser.add_argument("--save_interval", type=int, default=10, help="save frequency")
    parser.add_argument(
    ...
    parser.add_argument("--embedding_layer_size", type=int, default=128) # 128
    ...
    parser.add_argument("--use_multi_branch", action="store_false")
    parser.add_argument(
    ...
    # Sanitize opts
    opt.gpus_str = opt.gpus  #here, gpus is 0
    opt.gpus = [int(gpu) for gpu in opt.gpus.split(",")]   # 2 iteration for loop
...
def get_model_resgcn(graph, opt):
    model_args = {
        ...
        "num_class": opt.embedding_layer_size,   # 128
